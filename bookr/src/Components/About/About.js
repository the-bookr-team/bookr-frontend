...
const About = () => {
	return (
		<div className="about">
			<h1>Meet our team</h1>
			<p>
				Spread all throughout the United States, we are four Lambda School students from various cohorts. With
				our unique backgrounds and diverse skill sets, we were able to pull off building this awesome project
				Bookr in two weeks.
			</p>
